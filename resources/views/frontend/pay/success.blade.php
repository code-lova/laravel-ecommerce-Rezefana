            ...
            <div class="container">
                <div class="row">
                    ...
                    <aside class="col-lg-10">
                        <div class="summary">
                            <h3 class="summary-title">Success..!!</h3><!-- End .summary-title -->

                            <h3 class="post-title" style="color: rgb(29, 173, 29);">ORDER PLACED SUCCESSFULLY</h3>
                            <br>
                            <p>Welldone Comerade <b>{{ $user->name }}</b>.
                                <br>Your details is now Undergoing validation. Navigate to 'Account/Profile' to see orders made.<br>
