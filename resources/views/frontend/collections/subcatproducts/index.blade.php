...
@section('meta_keyword',"$subcategory->meta_keyword")
...
<style>
    ...
    <main class="main">
        <div class="page-header text-center" style="background-image: url({{ asset('assets/images/page-header-bg.jpg') }})">
            <div class="container">
                <h1 class="page-title">{{ $subcategory->category->name }} - {{ $subcategory->name }}<span>Shop</span></h1>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
        <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> All {{ $subcategory->category->name }} {{ $subcategory->name }}</li>
                </ol>
            </div><!-- End .container -->
                                ...
                                <div class="collapse show" id="widget-4">
                                    <div class="widget-body">
                                        <div class="filter-items">
                                            @foreach ($subcategory->category->brands as $brandItems)
                                            @php
                                                $checked = [];
