                  ...
                  <div class="modal fade" id="modal-lg{{ $val->id }}">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('admin/edit-category/'.$val->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <input type="hidden" value="{{ $val->id }}">
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="{{ asset('uploads/category/'.$val->image) }}" style="width: 120px; height: 100px;"
                                        <br>
                                        <div class="form-group">
