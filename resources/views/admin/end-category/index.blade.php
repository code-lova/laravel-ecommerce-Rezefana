    ...
    <div class="modal fade" id="modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('admin/add-endcategory') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                        <!-- text input -->
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="cat_id" required id="category_dd">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sub_cat_id" required id="subcategory_dd">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#modal-lg">Add End Category</button>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">End Categories</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="{{ url('admin/edit-endcat/'.$val->id) }}" type="button" class="btn btn-primary"><i class="fas fa-edit"></i>Update</a>
                  ...
                  <div class="modal fade" id="modal-danger{{ $val->id }}">
                    <div class="modal-dialog">
                      <div class="modal-content bg-danger">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('admin/delete-itemcategory/'.$val->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
